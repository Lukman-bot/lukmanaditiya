<div class="container">
	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			<label for="title" class="col-sm-2 col-form-label">Judul Lagu</label>
			<div class="col-sm-10">
		...
		<div class="form-group row">
			<label for="content" class="col-sm-2 col-form-label">Lirik Lagu</label>
			<div class="col-sm-10">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<?php if(!empty($input->photo)) : ?>
					<img src="<?= base_url("img/lagu/thumbs/$input->photo") ?>" alt="">
				<?php else: ?>
					<p>No Photo</p>
				<?php endif; ?>
				<br> 
		...
		<div class="row mt-4">
			<div class="col-10 offset-2">
				<a href="<?= base_url('lirik') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>Kembali</a>
