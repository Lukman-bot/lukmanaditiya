<div class="container">
	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			<label for="content" class="col-sm-2 col-form-label">Isi Postingan</label>
			<div class="col-sm-10">
        ...
        <div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="harga" id="harga" value="<?= $input->harga ?>" required class="form-control">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<?php if(!empty($input->photo)) : ?>
					<img src="<?= base_url("img/postingan/thumbs/$input->photo") ?>" alt="">
				<?php else: ?>
					<p>No Photo</p>
				<?php endif; ?>
				<br> 
