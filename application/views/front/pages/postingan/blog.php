...
<div class="jumbotron banner_area jumbotron-fluid" style="background-image: url(<?= base_url('img/pic03.jpg') ?>); ">
	<div class="container">
		<h1 class="display-4 my-auto text-light text-center">Postingan</h1>
	</div>
</div>
...
<div class="last-news mt-5">
	<div class="container">
		<div class="row mt-4">
			<?php foreach($post as $n) : ?>
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 my-3">
					<div class="card" style="width: 15rem; height: 24rem;">
						<img style="height:150px" src="<?= base_url('img/postingan/' . $n->photo) ?>" class="card-img-top">
						<div class="card-body">
